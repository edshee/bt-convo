...
var ConversationPanel = (function() {
    ...
    function inputKeyDown(event, inputBox) {
        ...
        if (event.keyCode === 13 && inputBox.value) {
            ...
            checkTones(inputBox.value, context);
...
function checkTones(inputText, context) {
    $.get('http://aibtts.eu-gb.mybluemix.net/api/anger?text=' + inputText, function(data) {
        if (data > 0.8) {
            var message = {
                output: {
                    text: "It seems you are getting frustrated with our bot. I am now transferring you to a live agent."
                }
            };
            var userMessage = {
                output: {
